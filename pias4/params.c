...
int PIAS_PRIO_DSCP[PIAS_PRIO_NUM] = {56, 48, 40, 32, 24, 16, 8, 0};
//int PIAS_PRIO_THRESH[PIAS_PRIO_NUM - 1] = {909*1460, 1329*1460, 1648*1460, 1960*1460, 2143*1460, 2337*1460, 2484*1460};
int PIAS_PRIO_THRESH[PIAS_PRIO_NUM - 1] = {50*1024, 100*1024, 512*1024, 1024*1024, 5120*1024, 10240*1024, 20480*1024};
